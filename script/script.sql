...
CREATE TABLE TANQUES (
    ...
    DESCRICAO       VARCHAR(50) NOT NULL, -- Ex: "Gasolina Comum", "Óleo Diesel"
...
CREATE TABLE ABASTECIMENTOS (
    ...
    CONSTRAINT FK_ABASTECIMENTO_BOMBA FOREIGN KEY (ID_BOMBA)
        ...
        ON DELETE CASCADE
        ON UPDATE CASCADE,
    CONSTRAINT CHK_IMPOSTO CHECK (IMPOSTO = VALOR_TOTAL * 0.13)
);
...
SET TERM ^ ;
CREATE TRIGGER TRG_ABASTECIMENTO_BI FOR ABASTECIMENTO
...
INSERT INTO TANQUES (ID_TANQUE, DESCRICAO, TIPO_COMBUSTIVEL) VALUES (2, 'Óleo Diesel', 'DIESEL');
